...
class Signal(QObject):
    # initialize Signal with input type string
...
class Widget(QWidget):
    ...
    def initUI(self):
        ...
        # This widget for making tab in text editor
        tab = QTabWidget()
        tx = text_widget()
        tab.addTab(tx, "Tab"+"1")

        # error messeges and succeeded connections shown here
        global text2
        text2 = QTextEdit()
        ...
        # splitter to seperate horizontally left&right
        H_splitter = QSplitter(Qt.Horizontal)
        H_splitter.addWidget(Left_hbox_Layout)
        H_splitter.addWidget(Right_hbox_Layout)
        H_splitter.setStretchFactor(1, 1)

        # splitter to seperate between the upper and lower sides
    ...
    #save the text inside the first text editor
    @pyqtSlot(str)
    def Saving(s):
        if language == "Python":
    ...
    # set the string to the text editor
    @pyqtSlot(str)
    def Open(s):
        global text
        text.setText(s)
...
# establish connection with widget class and send input string
@pyqtSlot(str)
def reading(s):
    b = Signal()
...
class UI(QMainWindow):
    ...
    def intUI(self):
        ...
        # copyrights of serial_ports() function taken from a ready made code on stackoverflow
